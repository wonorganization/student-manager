...
<script>
    ...
    function goUpdate(id){
        var data;
        postAsync('${ctx}/productImgList/getProductImgList',{'id':id},function(result){data=result.data});
    ...
    function update(){
        ...
        postAjax('${ctx}/productImgList/update',param,function(result){
            if(result.success){
